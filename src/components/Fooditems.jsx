...
function Fooditems(props) {
  ...
  return (
    <div className="bg-[#F4F1EA] py-24 sm:py-32 sm:px-10">
...
//   return (
//     <div className="bg-[#F4F1EA] py-24 sm:py-32 sm:px-10">
//       <div className="mx-auto max-w-6xl px-6 lg:px-8 overflow-x-hidden container">
//       <div className="mx-auto max-w-2xl overflow-hidden lg:max-w-4xl w-full flex flex-col items-center text-center">
...
//         <div className="mx-auto mt-10 grid max-w-3xl grid-cols-1 gap-x-5 gap-y-16  pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-4 md:grid-cols-3">
//           {posts.map((post) => (
//             <div key={post.id} className=" flex max-w-xl h-80 flex-col  items-start justify-between">
//               <article className=" w-full h-full relative">
//               <div className="mt-3 flex items-center justify-center relative">
//   {/* Rotating Dotted Border */}
//   <motion.div
